...
var evnClick = function(app){
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for(app in appList){
                $('.versionsManage').append('<li><div class="app" >
                    <span>' + appList[app].version + '</span></div><div class="handle"  >
                    <span id='+appList[app].version+' onclick="deleteApp(id)">删除</span></div></li>')
            }
